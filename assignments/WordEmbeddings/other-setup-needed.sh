wget $(python data_path_to_download_url.py "assignments/WordEmbeddings/wordvec_tests.py")
wget $(python data_path_to_download_url.py "assignments/WordEmbeddings/glove.py")
